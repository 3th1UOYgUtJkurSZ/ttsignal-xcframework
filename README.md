...
| | Value |
|---|---|
| Version | `1.0.20260612-1` |
| xcframework | [`ttsignal-swift.zip`](https://github.com/3th1UOYgUtJkurSZ/ttsignal-xcframework/releases/download/1.0.20260612-1/ttsignal-swift.zip) |
| SPM checksum | `b90c8aa1e42a035bb446b8253a7c4b43988fe1fbb8bf91f4ee08389d003e24f7` |
| SHA-256 | `b90c8aa1e42a035bb446b8253a7c4b43988fe1fbb8bf91f4ee08389d003e24f7` |
| Min iOS | 13.0 |
...
Pin to the version above (or `from: "1.0.20260612-1"`). Or in
`Package.swift`:
...
```ruby
pod 'TTSignal', :git => 'https://github.com/3th1UOYgUtJkurSZ/ttsignal-xcframework.git', :tag => '1.0.20260612-1'
```
...
`1.0.20260612-1` follows `1.0.YYYYMMDD`, where the patch component
